package com.corporate.tasks.transferencias.crearTransferencias;
...
import static com.corporate.UI.transferencias.crearTransferencias.UATUnaMuchasUI.*;
...
//            Festivos=excel.leerDatosExcel(rutaExcelOperaciones, "Hoja2",i, 11);
            Desde="434973350 - CC 350 ADRI";
            Frecuencia="Una Sola Vez";
            Programacion="Semanal";
            Notransf="Enviar";
            Cuentas="019813542;0006186530";
            Valores="10000.30;20000.30";
            Festivos="Proximo dia";

            actor.attemptsTo(
                    Click.on(SEL_DESDE_UAT),
                    Click.on(By.xpath("//*[contains(text(), '"+Desde+"')]")),
                    Enter.theValue("17/09/2025").into(TXT_FECHA_UAT),
                    Click.on(LABEL_FECHA_UAT));
//            if(Frecuencia.equals("Una Sola Vez"))
//            {
                actor.attemptsTo(
                        Click.on(RADIO_UNA_SOLA_VEZ_UAT),
                        //Check.whether("No").equals("Si")).andIfSo(Click.on(CHECK_NOTA_UAT), Enter.theValue(excel.leerDatosExcel(rutaExcelOperaciones, "Hoja1",i, 4)).into(TXT_NOTA_UAT)),
                        Click.on(CHECK_APROBAR_ENVIAR_UAT),
...
//            }
            ...
            actor.attemptsTo(
                    ...
                    Enter.theValue("Corporate39*").into(TXT_CONTRASENA3),
